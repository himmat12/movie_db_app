...
class EpisodeFlexibleSpacebarComponent extends StatelessWidget {
  ...
  late final String seasonNo;
  late final String episodeNo;
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      initState: (_) {
        ...
        seasonNo = "${episode.seasonNumber}".padLeft(2, '0');
        episodeNo = "${episode.episodeNumber}".padLeft(2, '0');
      },
