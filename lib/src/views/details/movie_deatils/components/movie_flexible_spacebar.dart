...
class MovieFlexibleSpacebarComponent extends StatelessWidget {
  MovieFlexibleSpacebarComponent({required this.movie, this.height, Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      initState: (_) {
        ...
        movieDate = releaseDate!.substring(0, 4);
      },
