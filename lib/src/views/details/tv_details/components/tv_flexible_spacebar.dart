...
class TvFlexibleSpacebarComponent extends StatelessWidget {
  TvFlexibleSpacebarComponent({required this.tv, this.height, Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      initState: (_) {
        ...
        tvDate = releaseDate.substring(0, 4);
      },
