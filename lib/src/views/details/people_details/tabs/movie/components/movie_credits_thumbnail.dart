...
class MovieCreditsThumbnailCard extends GetView<ResultsController> {
  const MovieCreditsThumbnailCard(
      {required this.movie, required this.imageUrl, this.padding, Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        // ignore: avoid_print
        // print('${_peopleController.movie.title}, ${controller.movie.id}');

        Get.offAllNamed('/movie_details',
            parameters: {"movieId": controller.movieId});
      },
      child: SizedBox(
        width: 100,
        height: 186,
