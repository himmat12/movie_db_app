...
class PeopleFlexibleSpacebarComponent extends StatelessWidget {
  PeopleFlexibleSpacebarComponent({required this.people, this.height, Key? key})
      : super(key: key);
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              _peopleController
                                      .people.value.knownForDepartment ??
                                  'department',
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
