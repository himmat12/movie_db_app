...
PreferredSizeWidget? peopleBottomTabbarComponent(
...
class TabbarItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        _utilityController.setPeopleTabbarIndex(index);
      },
      child: Container(
        height: 80,
        ...
        child:
            ...
            //Obx(() =>
            GetBuilder(
          id: 'peopleBottomTabBar',
          init: _utilityController,
          builder: (controller) => Text(
            title,
            style: TextStyle(
              fontSize: m - 6,
              color: _utilityController.peopleTabbarCurrentIndex == index
